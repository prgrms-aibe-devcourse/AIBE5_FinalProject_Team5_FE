...
export const COMPARE_TABLE_ROWS: CompareTableRow[] = [
  ...
  { type: 'field', label: '기관 위치', getValue: (c) => c.institutionAddress },
  ...
  { type: 'field', label: '지원 인원', getValue: (c) => `${c.recruitment.applicants}명` },
  { type: 'field', label: '확정 인원', getValue: (c) => `${c.recruitment.confirmed}명` },
